...
public class MySQLManager {
    ...
    public static boolean containsPlayer(String tableName, Player p) {
        return getObjectConditionResult(tableName, "UUID", UUIDFetcher.getUUID(p.getName()).toString(), "Kills") != null;
    }
    ...
    public static void exUpdateQry(String tableName, String conditionvalue, String column, String updatevalue) {
        if (MySQLAPI.isConnected()) {
            try {
    ...
    public static Object getObjectConditionResult(String tableName, String condition, String value, String column) {
        if (MySQLAPI.isConnected()) {
            try {
    ...
    public static ArrayList<UUID> getConditionListResult(String tableName, String condition, String value, String column) {
        ...
        ResultSet rs = MySQLManager.getResult("SELECT * FROM " + tableName);
